...
#include <traffic_light/KlogStorageEntity.edl.h>
...
int main(int argc, char *argv[])
{
    ...
    return klog_storage_run(KLOG_STORAGE_SERVER_CONNECTION_ID, KlogStorageEntity_klogStorage_iidOffset, KlogStorageEntity_klogStorage_storage_iid, comp);
}